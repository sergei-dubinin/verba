#!/usr/bin/env python3
"""Замер срабатывания скилла verba-ui.

Копия verba-implement/evals/measure_triggers.py; отличается только SKILL.
...
где лежит .claude/skills/verba-ui, и ловится вызов инструмента
Skill с skill=verba-ui. Соседний скилл (чаще всего verba-implement)
попадает в other_skills: так видно, куда уходят промахи.
...
сессии Claude Desktop CLI отвечает «Not logged in»):
    ...
    python3 .claude/skills/verba-ui/evals/measure_triggers.py \
        .claude/skills/verba-ui/evals/trigger-evals.json /tmp/verba-probe 3
